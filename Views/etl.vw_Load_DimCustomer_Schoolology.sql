...
*****/ 
CREATE VIEW [etl].[vw_Load_DimCustomer_Schoolology] AS 
...
*/ 
              SELECT 
                      ...
                      , 'Schoology' AS [SourceSystem] 
                      , 0 AS [SourceSystemPriority] --0-100 100 is higher Priority 
 
                      /*Standard Attributes*/ 
                      , CAST(UID AS NVARCHAR(25)) [SSID] 
                      , CAST(CASE [role-id] WHEN 262825 THEN 'Admin' WHEN 262827 THEN 'Faculty' WHEN 262829 THEN 'Student' END AS NVARCHAR(50)) AS [CustomerType] 
                      ...
                      , [name-first-preferred] AS [SalutationName] 
                      , NULL AS [DonorMailName] 
                      , NULL AS [DonorFormalName] 
                      , CAST(birthday_date AS DATE) AS [Birthday] 
                      , gender AS [Gender] --ADD GENDER!! 
                      , 0 [MergedRecordFlag] 
                      , NULL [MergedIntoSSID] 
 
                      /**ENTITIES**/ 
                      /*Name*/                      
                      , [name-display] AS FullName 
                      , [name-title] AS [Prefix] 
                      , [name-first] AS [FirstName] 
                      --, master.dbo.TI_FirstName(FullName) AS [FirstName] 
                      , [name-middle] AS [MiddleName] 
                      ...
                      /*Phone*/ 
                      , CAST(phone AS NVARCHAR(25)) AS [PhonePrimary] 
                      ...
                      /*Email*/ 
                      , [primary-email] AS [EmailPrimary] 
                      , NULL AS [EmailOne] 
                      , NULL AS [EmailTwo] 
 
                      /*Extended Attributes*/ 
                      , [grad-year] AS[ExtAttribute1] --nvarchar(100) 
                      ...
                      , CAST([school-uid] AS NVARCHAR(25)) AS[ExtAttribute10]  
				...
				FROM [ods].[Schoology_users] 
				WHERE uid NOT IN ('52702920','55347148','55347150','52702922')
