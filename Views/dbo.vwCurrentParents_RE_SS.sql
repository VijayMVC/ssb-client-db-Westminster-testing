...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[vwCurrentParents_RE_SS]
as
...
WHERE (b.SS_Current_Parent = 1 OR b.RE_Current_Parent = 1 ) --OR b.SS_Current_Parent = 1 OR b.SS_Current_FactStaff = 1 OR b.RE_Current_Parent = 1 OR b.RE_Current_FactStaff)
)z
