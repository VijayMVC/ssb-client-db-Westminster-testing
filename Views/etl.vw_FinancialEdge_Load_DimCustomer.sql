...
CREATE VIEW [etl].[vw_FinancialEdge_Load_DimCustomer] AS  
( 
...
*/ 
              SELECT 
                      ...
                      /**ENTITIES**/ 
                      /*Name*/                      
                      , CASE WHEN [first-name] + [last-name] <> '' THEN CONCAT([first-name], ' ', [last-name]) else [vendor-name] END AS FullName 
                      , title AS [Prefix] 
                      ...
                      /*AddressPrimary*/ 
                      , [address-line] AS [AddressPrimaryStreet] 
                      , city AS [AddressPrimaryCity]  
                      , state AS [AddressPrimaryState]  
                      , postal AS [AddressPrimaryZip]  
                      , county AS [AddressPrimaryCounty] 
