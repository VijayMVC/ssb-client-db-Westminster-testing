...
*****/ 
 ...
 CREATE VIEW [etl].[vw_Load_DimCustomer_Paycom] AS 
...
*/ 
              SELECT 
                      ...
                      , 'Paycom' AS [SourceSystem] 
                      , 0 AS [SourceSystemPriority] --0-100 100 is higher Priority 
 
                      /*Standard Attributes*/ 
                      , CAST(a.Employee_Code AS NVARCHAR(25)) [SSID] 
                      , CAST(a.Position AS NVARCHAR(50)) AS [CustomerType] 
                      , CAST(a.Employee_Status AS NVARCHAR(50)) AS [CustomerStatus] 
                      , CAST(NULL AS NVARCHAR(50)) AS [AccountType]  
                      , CAST(NULL AS NVARCHAR(50)) AS [AccountRep]  
                      , CAST(NULL AS NVARCHAR(50)) AS [CompanyName]  
                      , a.Nickname AS [SalutationName] 
                      , NULL AS [DonorMailName] 
                      , NULL AS [DonorFormalName] 
                      , TRY_CAST(NULL AS DATE) AS [Birthday] 
                      , a.Gender AS [Gender] --ADD GENDER!! 
                      , 0 [MergedRecordFlag] 
                      , NULL [MergedIntoSSID] 
 
                      /**ENTITIES**/ 
                      /*Name*/                      
                      , a.Employee_Name  AS FullName 
                      , NULL AS [Prefix] 
                      ...
                      /*AddressPrimary*/ 
                      , a.Street AS [AddressPrimaryStreet] 
                      , a.City AS [AddressPrimaryCity]  
                      , a.State AS [AddressPrimaryState]  
                      , a.Zipcode AS [AddressPrimaryZip]  
                      , NULL AS [AddressPrimaryCounty] 
                      , 'United States' AS [AddressPrimaryCountry]  
                      ...
                      /*Phone*/ 
                      , CAST(a.Primary_Phone AS NVARCHAR(25)) AS [PhonePrimary] 
                      , CAST(a.Secondary_Phone AS NVARCHAR(25)) AS [PhoneHome] 
                      ...
                      /*Email*/ 
                      , a.Work_Email AS [EmailPrimary] 
                      , a.Personal_Email AS [EmailOne] 
                      , NULL AS [EmailTwo] 
 
                      /*Extended Attributes*/ 
                      , NULL  AS[ExtAttribute1] --nvarchar(100) 
                      , a.Department +'-' + a.Department_Desc AS[ExtAttribute2]  
                      , a.Division_Desc AS[ExtAttribute3]  
