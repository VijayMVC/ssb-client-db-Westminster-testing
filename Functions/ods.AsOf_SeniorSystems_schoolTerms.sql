...
SELECT * FROM [ods].[AsOf_SeniorSystems_schoolTerms] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_SeniorSystems_schoolTerms] (@AsOfDate DATETIME)
...
FROM
	...
	FROM [ods].[Snapshot_SeniorSystems_schoolTerms]
	) a
WHERE
