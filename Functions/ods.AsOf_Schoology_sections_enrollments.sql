...
SELECT * FROM [ods].[AsOf_Schoology_sections_enrollments] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_Schoology_sections_enrollments] (@AsOfDate DATETIME)
...
[cross_listed_section_school_code] [nvarchar](500) NULL,
...
FROM
	...
	FROM [ods].[Snapshot_Schoology_sections_enrollments]
	) a
WHERE
