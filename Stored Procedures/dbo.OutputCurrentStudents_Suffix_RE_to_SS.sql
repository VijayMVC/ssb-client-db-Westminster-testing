...
CREATE PROC [dbo].[OutputCurrentStudents_Suffix_RE_to_SS] 
	@IssueID	INT 
	AS
...
SET @sql =
	...
	UNION  ALL
	SELECT ''Raisers Edge Source Record - This will be the new suffix from Raisers Edge'' SourceHeader, bi.OtherID,a.Prefix,a.FirstName,a.MiddleName,a.LastName,a.Suffix,a.ExtAttribute1 AS ClassYear
