...
CREATE PROC [dbo].[OutputCurrentStudents_Suite_SS_to_RE] 
	@IssueID	INT 
	AS
...
SET @sql =
	...
	UNION  ALL
	SELECT ''Senior Systems Source Record - This is the address in Senior'' SourceHeader, bi.OtherID,a.Prefix,a.FirstName,a.MiddleName,a.LastName,a.Suffix,a.ExtAttribute1 AS ClassYear
