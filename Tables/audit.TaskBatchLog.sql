...
[CreatedOn] [datetime] NULL CONSTRAINT [DF__TaskBatch__Creat__75C27486] DEFAULT ([etl].[ConvertToLocalTime](CONVERT([datetime2](0),getdate(),(0)))),
[CreatedBy] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__TaskBatch__Creat__76B698BF] DEFAULT (suser_sname())
)
GO
ALTER TABLE [audit].[TaskBatchLog] ADD CONSTRAINT [PK__TaskBatc__3214EC27BDD2C4ED] PRIMARY KEY CLUSTERED  ([ID])
GO
