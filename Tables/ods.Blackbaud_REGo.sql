CREATE TABLE [ods].[Blackbaud_REGo]
(
[SessionId] [uniqueidentifier] NULL,
[RecordCreateDate] [datetime] NOT NULL CONSTRAINT [DF__UploadREG__Recor__44CDF1CC] DEFAULT (getutcdate()),
[Processed] [bit] NOT NULL CONSTRAINT [DF__UploadREG__Proce__45C21605] DEFAULT ((0)),
